...
class EnhanceDocumentsCommand extends Command
{
    /**
     * Configure.
     *
    ...
    protected function configure(): void
    {
        ...
        $this->setName('migrate:enhance-migrated-documents');
    ...
    {
        OrderDocumentMigrator::enhanceAllMigratedDocuments((new ExecuteManager())->setProgressBar(new ProgressBar($output)));
